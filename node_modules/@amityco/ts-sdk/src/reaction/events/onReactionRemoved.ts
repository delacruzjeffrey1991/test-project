...
import { onPostReactionRemoved } from '~/post/events';
import { onCommentReactionRemoved } from '~/comment/events';
...
export const onReactionRemoved = (
  ...
  callback: Amity.Listener<Amity.Model[typeof referenceType]>,
): Amity.Unsubscriber => {
  const callbackWrapper = (model: Amity.Model[typeof referenceType]) => {
