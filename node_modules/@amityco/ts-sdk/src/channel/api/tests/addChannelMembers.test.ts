...
describe('addChannelMembers', () => {
  ...
  test('it should update cache with channel members', async () => {
    ...
    expect(channelUser).toBe(channelUser1);
  ...
  test('it should fire event with all new members', async () => {
    ...
    const { userId: userId2 } = channelUser3;
     ...
     */
    expect(callback).toHaveBeenNthCalledWith(1, { ...channel11 }, { ...channelUser1 });
    expect(callback).toHaveBeenNthCalledWith(2, { ...channel11 }, { ...channelUser3 });
