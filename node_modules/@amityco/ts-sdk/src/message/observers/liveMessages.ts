...
import { onMessageCreated, onMessageDeleted, onMessageUpdated, onMessageFetched } from '../events';
...
export const liveMessages = (
  ...
  const realtimeRouter = (message: Amity.Message, action: Amity.MessageActionType) => {
    ...
    if (params.channelId !== message.channelId || !collection) return;
  ...
  disposers.push(
    ...
    onMessageCreated(message => realtimeRouter(message, 'onCreate')),
