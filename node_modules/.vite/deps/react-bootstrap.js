import {
  ...
  useNavItem,
  usePrevious
} from "./chunk-5T5N7QBW.js";
import {
  TabContainer_default,
  Tab_default
} from "./chunk-2CKFBITX.js";
import {
...
var Modal = (0, import_react35.forwardRef)((_ref, ref) => {
  ...
  if (Transition) {
    dialog = (0, import_jsx_runtime60.jsx)(Transition, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition3) {
      backdropElement = (0, import_jsx_runtime60.jsx)(BackdropTransition3, {
        appear: true,
        in: !!show,
...
var Modal2 = React62.forwardRef(({
  ...
  const renderBackdrop = (0, import_react37.useCallback)((backdropProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React68.forwardRef(({
  ...
  const renderBackdrop = (0, import_react42.useCallback)((backdropProps) => (0, import_jsx_runtime73.jsx)("div", {
    ...backdropProps,
...
var Overlay = React72.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime80.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime86.jsxs)(import_jsx_runtime85.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react49.cloneElement)(children, triggerProps), (0, import_jsx_runtime84.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
